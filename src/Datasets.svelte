...
<div class="container mt-4">
    ...
    <div class="welcome-section">
        ...
        <div class="features">
            <div class="container">
                <div class="row">
                  <a href="javascript:void(0);" on:click={() => navigateTo('/logs')}  class="col-4 bg-primary text-white text-center py-3">
                    
                      <span class="fa fa-clipboard-list"></span> Registros
                    </a>
                  
                  <a href="javascript:void(0);" on:click={() => navigateTo('/users')}  class="col-8 bg-warning text-black text-center py-3">
